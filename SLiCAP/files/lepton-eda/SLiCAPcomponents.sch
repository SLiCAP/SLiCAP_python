...
C -46400 80900 1 0 0 C.sym
{
T -46250 82175 5 6 0 0 0 0 1
device=C-slicap
T -45850 81500 5 8 1 1 0 0 1
refdes=C1
T -45850 81350 5 8 1 0 0 0 1
value={C}
T -45847 81192 5 8 1 0 0 0 1
vinit=0
}
C -44700 81000 1 0 0 D.sym
{
T -44700 82200 5 6 0 0 0 0 1
device=D-spice
T -44400 81350 5 8 1 1 0 0 1
model-name=?
T -44400 81500 5 8 1 1 0 0 1
refdes=D1
T -44400 81200 5 8 1 1 0 0 1
params=?
}
C -43600 80900 1 0 0 E.sym
{
T -44700 82600 5 8 0 0 0 0 1
device=E-slicap
T -43100 82100 5 8 1 1 0 0 1
refdes=E1
T -43100 81950 5 8 1 1 0 0 1
value=?
}
C -42100 80900 1 0 0 EZ.sym
{
T -42800 82450 5 6 0 0 0 0 1
device=EZ-slicap
T -41750 82100 5 8 1 1 0 0 1
refdes=E2
T -41750 81950 5 8 1 1 0 0 1
value=?
T -41056 81945 5 8 1 1 0 0 1
zo=?
}
C -38600 80900 1 0 0 G.sym
{
T -39300 82500 5 6 0 0 0 0 1
device=G-slicap
T -38150 82100 5 8 1 1 0 0 1
refdes=G1
T -38150 81950 5 8 1 1 0 0 1
value=?
}
C -37100 80900 1 0 0 G_g.sym
{
T -37800 82500 5 6 0 0 0 0 1
device=G-slicap
T -36650 82100 5 8 1 1 0 0 1
refdes=G2
T -36650 81950 5 8 1 1 0 0 1
value=?
}
...
C -47600 81000 1 0 0 L.sym
{
T -47750 82200 5 6 0 0 0 0 1
device=L-slicap
T -47350 81400 5 8 1 0 0 0 1
value=?
T -47350 81550 5 8 1 1 0 0 1
refdes=L1
T -47343 81219 5 8 1 0 0 0 1
iinit=?
}
...
C -29100 80900 1 0 0 N.sym
{
T -29800 82375 5 6 0 0 0 0 1
device=N-slicap
T -28600 81950 5 8 1 1 0 0 1
refdes=N1
}
...
C -32100 80900 1 0 0 T.sym
{
T -32800 82550 5 6 0 0 0 0 1
device=T-slicap
T -31600 82200 5 8 1 1 0 0 1
refdes=T1
T -31600 82050 5 8 1 1 0 0 1
value=?
}
...
C -30600 80900 1 0 0 W.sym
{
T -31300 82350 5 6 0 0 0 0 1
device=W-slicap
T -30100 82050 5 8 1 1 0 0 1
value=?
T -30100 82200 5 8 1 1 0 0 1
refdes=W1
}
...
T -27350 82700 5 8 1 1 0 0 1
refdes=X12
T -26850 82700 5 8 1 0 0 0 1
A={A}
T -26850 82500 5 8 1 0 0 0 1
B={B}
T -26850 82300 5 8 1 0 0 0 1
C={C}
T -26850 82100 5 8 1 0 0 0 1
D={D}
}
...
C -40300 80900 1 0 0 F.sym
{
T -41000 82500 5 6 0 0 0 0 1
device=F-slicap
T -39850 82200 5 8 1 1 0 0 1
refdes=F?
T -39850 82050 5 8 1 1 0 0 1
value=?
T -39850 81892 5 8 1 0 0 0 1
ref=
}
C -35800 80900 1 0 0 H.sym
{
T -36500 82500 5 6 0 0 0 0 1
device=H-slicap
T -35150 82100 5 8 1 1 0 0 1
refdes=H?
T -35150 81950 5 8 1 1 0 0 1
value=?
T -35150 81850 5 8 1 0 0 0 1
ref=?
}
C -34500 80900 1 0 0 HZ.sym
{
T -34150 82100 5 8 1 1 0 0 1
refdes=H?
T -34150 81950 5 8 1 0 0 0 1
value=?
T -33450 81950 5 8 1 0 0 0 1
zo=?
T -35243 82500 5 6 0 0 0 0 1
device=HZ-slicap
T -33850 82100 5 8 1 0 0 0 1
ref=?
}
C -30800 76800 1 0 0 XM_noisyNullor.sym
{
T -31250 78700 5 6 0 0 0 0 1
device=Noisy nullor with MOS input nouse sources
T -30300 78300 5 8 1 1 0 0 1
refdes=X?
T -30300 78150 5 8 1 0 0 0 1
W={W}
T -30300 78000 5 8 1 0 0 0 1
L={L}
T -29650 78150 5 8 1 0 0 0 1
ID={ID}
T -29658 77992 5 8 1 0 0 0 1
IG={IG}
T -29658 78292 5 8 1 0 0 0 1
model=?
}
