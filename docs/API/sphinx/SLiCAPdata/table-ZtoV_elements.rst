.. csv-table:: Expanded netlist element data
    ...
    "", "", "", "", "dc", :math:`0`, :math:`0`
    "", "", "", "", "dcvar", :math:`0`, :math:`0`
    "E_O1", "int_O1 0 in 1 ", "", "E", "value", :math:`\frac{A_{0}}{1 + \frac{0.5 s}{\pi p_{1}}}`, :math:`\frac{A_{0}}{1 + \frac{0.1592 s}{p_{1}}}`
    "H_O1", "2 int_O1 ", "H_O1 ", "H", "value", :math:`R_{o}`, :math:`R_{o}`
    ...
    "", "", "", "", "vinit", :math:`0`, :math:`0`
    "E_O2", "int_O2 0 0 3 ", "", "E", "value", :math:`\frac{A_{0}}{1 + \frac{0.5 s}{\pi p_{1}}}`, :math:`\frac{A_{0}}{1 + \frac{0.1592 s}{p_{1}}}`
    "H_O2", "out int_O2 ", "H_O2 ", "H", "value", :math:`R_{o}`, :math:`R_{o}`
